...
V Does each element have a unique class name?
V Did you use the grouping selector for styles that both elements share?
V Did you make separate rules for the styles unique to each element?
