...
### Self Check
V Did you properly chain class selectors for each rule?
V Does the `proportioned` image retain its original square proportions?
V Does the `distorted` image end up looking squished and, well, distorted?
