...
### Self Check
V Did you use all three methods of adding CSS to an HTML file?
V Did you properly link the external CSS file in the HTML file?
V Does the `div` element have CSS added via the external method?
V Does the `p` element have CSS added via the internal method?
V Does the `button` element have CSS added via the inline method?
